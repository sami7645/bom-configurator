...
urlpatterns = [
    ...
    path('api/delete-bom-items/', views.delete_bom_items, name='delete_bom_items'),
    path('api/delete-configurations/', views.delete_configurations, name='delete_configurations'),
